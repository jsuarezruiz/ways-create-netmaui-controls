...
{
    public class CustomCheckBox : ContentView, IDisposable
    {
        ...
        public static readonly BindableProperty ColorProperty =
            BindableProperty.Create(nameof(Color), typeof(Brush), typeof(CustomCheckBox), Brush.DeepPink);
        ...
        {
            if (!(bindable is CustomCheckBox checkbox)) return;
